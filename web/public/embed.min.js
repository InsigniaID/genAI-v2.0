(function () {
  const configKey = "genaiChatbotConfig"; const buttonId = "genai-chatbot-bubble-button"; const iframeId = "genai-chatbot-bubble-window"; const config = window[configKey]; let isExpanded = false; const svgIcons = `<svg id="openIcon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
