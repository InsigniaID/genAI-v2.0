const translation = {
  ...
  welcome: 'Bienvenido a GenAI, por favor inicia sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con GenAI Community Edition, lee la',
  ...
  resetPasswordDesc: 'Escriba el correo electrónico que utilizó para registrarse en GenAI y le enviaremos un correo electrónico de restablecimiento de contraseña.',
  ...
  licenseInactiveTip: 'La licencia de GenAI Enterprise para su espacio de trabajo está inactiva. Póngase en contacto con su administrador para seguir utilizando GenAI.',
  licenseExpired: 'Licencia caducada',
  licenseLost: 'Licencia perdida',
  licenseExpiredTip: 'La licencia de GenAI Enterprise para su espacio de trabajo ha caducado. Póngase en contacto con su administrador para seguir utilizando GenAI.',
  licenseLostTip: 'No se pudo conectar el servidor de licencias de Dife. Póngase en contacto con su administrador para seguir utilizando GenAI.',
  webapp: {
