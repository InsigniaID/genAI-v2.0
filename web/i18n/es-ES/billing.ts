const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se refiere al número de llamadas API que invocan solo las capacidades de procesamiento de base de conocimientos de GenAI.',
    ...
    apiRateLimitTooltip: 'El límite de tasa de la API se aplica a todas las solicitudes realizadas a través de la API de GenAI, incluidos la generación de texto, las conversaciones de chat, las ejecuciones de flujo de trabajo y el procesamiento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SLAs negociados con socios de GenAI',
        'Seguridad y controles avanzados',
        'Actualizaciones y mantenimiento oficiales por parte de GenAI',
    ...
    community: {
      ...
      features: [
        ...
        'Cumple con la licencia de código abierto de GenAI',
      ],
    },
    premium: {
