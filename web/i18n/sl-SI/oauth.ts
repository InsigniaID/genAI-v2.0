const translation = {
  tips: {
    notLoggedIn: 'Ta aplikacija želi dostopati do vašega GenAI Cloud računa',
    loggedIn: 'Ta aplikacija želi dostopati do naslednjih informacij iz vašega računa GenAI Cloud.',
