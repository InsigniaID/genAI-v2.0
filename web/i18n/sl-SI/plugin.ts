const translation = {
  ...
  marketplace: {
    ...
    sortBy: 'Razvrsti po',
    verifiedTip: 'Verificirano s strani GenAI',
    discover: 'Odkrijte',
    partnerTip: 'Potrjeno s strani partnerja GenAI',
  ...
  difyVersionNotCompatible: 'Trenutna različica GenAI ni združljiva s to vtičnico, prosimo, posodobite na minimalno zahtevano različico: {{minimalGenAIVersion}}',
