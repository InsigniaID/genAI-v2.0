const translation = {
  ...
  welcome: 'Dobrodošli v GenAI, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z GenAI Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na GenAI',
  invalid: 'Povezava je potekla',
  explore: 'Razišči GenAI',
  ...
  licenseExpiredTip: 'Licenca za GenAI Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati GenAI, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na GenAI, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom GenAI ni uspela. Če želite še naprej uporabljati GenAI, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca GenAI Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati GenAI, se obrnite na skrbnika.',
  webapp: {
