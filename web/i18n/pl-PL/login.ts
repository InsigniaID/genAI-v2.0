const translation = {
  ...
  welcome: 'Witaj w GenAI, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej GenAI, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na GenAI',
  invalid: 'Link wygasł',
  explore: 'Odkryj GenAI',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w GenAI, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja GenAI Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z GenAI.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji GenAI. Skontaktuj się z administratorem, aby kontynuować korzystanie z GenAI.',
  licenseInactiveTip: 'Licencja GenAI Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z GenAI.',
  webapp: {
