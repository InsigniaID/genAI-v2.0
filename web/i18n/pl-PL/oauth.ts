const translation = {
  tips: {
    ...
    notLoggedIn: 'Ta aplikacja chce uzyskać dostęp do twojego konta GenAI Cloud',
    ...
    loggedIn: 'Ta aplikacja chce uzyskać dostęp do następujących informacji z twojego konta GenAI Cloud.',
  },
  scopes: {
