const translation = {
  ...
  marketplace: {
    ...
    and: 'i',
    difyMarketplace: 'Rynek GenAI',
    noPluginFound: 'Nie znaleziono wtyczki',
    pluginsResult: '{{num}} wyniki',
    partnerTip: 'Zweryfikowane przez partnera GenAI',
    verifiedTip: 'Zweryfikowane przez GenAI',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Obecna wersja GenAI nie jest kompatybilna z tym wtyczką, proszę zaktualizować do minimalnej wymaganej wersji: {{minimalGenAIVersion}}',
