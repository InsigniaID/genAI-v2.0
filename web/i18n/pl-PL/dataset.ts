const translation = {
  ...
  intro1: 'Wiedzę można zintegrować z aplikacją GenAI ',
  ...
  externalAPIPanelDescription: 'Interfejs API wiedzy zewnętrznej służy do łączenia się z bazą wiedzy poza GenAI i pobierania wiedzy z tej bazy wiedzy.',
  chunkingMode: {
