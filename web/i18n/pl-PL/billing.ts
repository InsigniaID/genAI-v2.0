const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip:
      'Odnosi się do liczby wywołań API wykorzystujących tylko zdolności przetwarzania bazy wiedzy GenAI.',
    receiptInfo:
    ...
    self: 'Samo-hostowane',
    apiRateLimitTooltip: 'Limit aktywności API dotyczy wszystkich żądań składanych za pośrednictwem API GenAI, w tym generowania tekstu, rozmów czatowych, wykonywania przepływów pracy i przetwarzania dokumentów.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Aktualizacje i konserwacja przez GenAI oficjalnie',
        5: 'Umowy SLA wynegocjowane przez GenAI Partners',
    ...
    community: {
      features: {
        ...
        2: 'Zgodny z licencją GenAI Open Source',
