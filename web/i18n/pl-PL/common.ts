const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto GenAI',
    langGeniusAccountTip: 'Twoje konto GenAI i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do GenAI, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez GenAI pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach GenAI.',
  ...
  about: {
    ...
    nowAvailable: 'GenAI {{version}} jest teraz dostępny.',
    latestAvailable: 'GenAI {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
