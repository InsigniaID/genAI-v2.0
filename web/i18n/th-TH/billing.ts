const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'หมายถึงจํานวนการเรียก API ที่เรียกใช้เฉพาะความสามารถในการประมวลผลฐานความรู้ของ GenAI',
    ...
    apiRateLimitTooltip: 'ข้อจำกัดการใช้งาน API จะใช้กับคำขอทั้งหมดที่ทำผ่าน GenAI API รวมถึงการสร้างข้อความ, การสนทนาแชท, การดำเนินการเวิร์กโฟลว์ และการประมวลผลเอกสาร.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'SSO',
        5: 'SLA ที่เจรจาโดย GenAI Partners',
        ...
        7: 'การอัปเดตและบํารุงรักษาโดย GenAI อย่างเป็นทางการ',
      },
    ...
    community: {
      features: {
        ...
        2: 'สอดคล้องกับใบอนุญาตโอเพ่นซอร์ส GenAI',
