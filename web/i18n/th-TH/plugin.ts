const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'ตลาด GenAI',
    partnerTip: 'ได้รับการตรวจสอบโดยพันธมิตรของ GenAI',
    verifiedTip: 'ได้รับการตรวจสอบโดย GenAI',
  },
  task: {
  ...
  difyVersionNotCompatible: 'เวอร์ชั่นปัจจุบันของ GenAI ไม่สามารถใช้งานร่วมกับปลั๊กอินนี้ได้ กรุณาอัปเกรดไปยังเวอร์ชั่นขั้นต่ำที่ต้องการ: {{minimalGenAIVersion}}',
