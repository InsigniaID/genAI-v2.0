const translation = {
  ...
  welcome: 'GenAI\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'GenAI Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'GenAI\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için GenAI Enterprise lisansının süresi doldu. GenAI\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'GenAI lisans sunucusuna bağlanılamadı. GenAI\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için GenAI Enterprise lisansı etkin değil. GenAI\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
