const translation = {
  ...
  intro1: 'Bilgi, GenAI uygulamasına ',
  ...
  externalAPIPanelDescription: 'Harici bilgi API\'si, GenAI dışındaki bir bilgi bankasına bağlanmak ve bu bilgi bankasından bilgi almak için kullanılır.',
