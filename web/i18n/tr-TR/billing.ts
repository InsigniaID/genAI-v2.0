const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'GenAI\'nin sadece bilgi tabanı işleme yeteneklerini çağıran API çağrıları sayısını ifade eder.',
    ...
    apiRateLimitTooltip: 'GenAI API\'si aracılığıyla yapılan tüm isteklerde, metin oluşturma, sohbet konuşmaları, iş akışı yürütmeleri ve belge işleme dahil olmak üzere, API Oran Sınırı uygulanır.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        ...
        7: 'Resmi olarak GenAI tarafından Güncellemeler ve Bakım',
        0: 'Kurumsal Düzeyde Ölçeklenebilir Dağıtım Çözümleri',
        5: 'GenAI Partners tarafından müzakere edilen SLA\'lar',
      },
    ...
    community: {
      features: {
        1: 'Tek Çalışma Alanı',
        2: 'GenAI Açık Kaynak Lisansı ile uyumludur',
