const translation = {
  ...
  intro1: 'دانش می‌تواند در برنامه GenAI ',
  ...
  externalAPIPanelDescription: 'API دانش خارجی برای اتصال به یک پایگاه دانش خارج از GenAI و بازیابی دانش از آن پایگاه دانش استفاده می شود.',
