const translation = {
  ...
  marketplace: {
    ...
    difyMarketplace: 'Mercado GenAI',
    moreFrom: 'Mais do Marketplace',
    noPluginFound: 'Nenhum plugin encontrado',
    discover: 'Descobrir',
    verifiedTip: 'Verificado pelo GenAI',
    partnerTip: 'Verificado por um parceiro da GenAI',
  },
  task: {
  ...
  difyVersionNotCompatible: 'A versão atual do GenAI não é compatível com este plugin, por favor atualize para a versão mínima exigida: {{minimalGenAIVersion}}',
