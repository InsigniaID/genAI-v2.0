const translation = {
  tips: {
    notLoggedIn: 'Este aplicativo quer acessar sua conta do GenAI Cloud',
    loggedIn: 'Este aplicativo quer acessar as seguintes informações da sua conta GenAI Cloud.',
