const translation = {
  toVerifiedTip: {
    ...
    end: 'para o Plano Profissional GenAI.',
  },
  form: {
    schoolName: {
    ...
    terms: {
      ...
      option: {
        inSchool: 'Eu confirmo que estou matriculado ou empregado na instituição mencionada. A GenAI pode solicitar comprovação de matrícula/emprego. Se eu representar indevidamente minha elegibilidade, concordo em pagar quaisquer taxas inicialmente isentas com base no meu status educacional.',
  ...
  successContent: 'Emitimos um cupom de desconto de 100% para o plano GenAI Professional na sua conta. O cupom é válido por um ano, por favor, utilize-o dentro do período de validade.',
  rejectTitle: 'A sua verificação educacional GenAI foi rejeitada.',
  rejectContent: 'Infelizmente, você não é elegível para o status de Educação Verificada e, portanto, não pode receber o cupom exclusivo de 100% para o Plano Profissional GenAI se usar este endereço de e-mail.',
  successTitle: 'Você Tem a Educação GenAI Verificada',
  ...
  notice: {
    expired: {
      summary: {
        ...
        line1: 'Você ainda pode acessar e usar o GenAI.',
      },
