const translation = {
  ...
  welcome: 'Bem-vindo ao GenAI, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do GenAI, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no GenAI',
  invalid: 'O link expirou',
  explore: 'Explorar o GenAI',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no GenAI e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do GenAI Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o GenAI.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças GenAI. Entre em contato com o administrador para continuar usando o GenAI.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do GenAI Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o GenAI.',
  webapp: {
