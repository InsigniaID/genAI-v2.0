const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Refere-se ao número de chamadas de API que invocam apenas as capacidades de processamento da base de conhecimento do GenAI.',
    ...
    apiRateLimitTooltip: 'O limite da taxa da API se aplica a todas as solicitações feitas através da API GenAI, incluindo geração de texto, conversas de chat, execuções de fluxo de trabalho e processamento de documentos.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        7: 'Atualizações e manutenção por GenAI oficialmente',
        ...
        5: 'SLAs negociados pela GenAI Partners',
    ...
    community: {
      features: {
        ...
        2: 'Está em conformidade com a licença de código aberto GenAI',
      },
      name: 'Comunidade',
