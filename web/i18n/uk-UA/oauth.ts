const translation = {
  tips: {
    notLoggedIn: 'Цей додаток хоче отримати доступ до вашого облікового запису GenAI Cloud',
    needLogin: 'Будь ласка, увійдіть, щоб авторизуватися.',
    loggedIn: 'Цей додаток хоче отримати доступ до наступної інформації з вашого облікового запису GenAI Cloud.',
