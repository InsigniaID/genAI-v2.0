const translation = {
  ...
  license: {
    tip: 'Before starting GenAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on GenAI',
  invalid: 'The link has expired',
  explore: 'Explore GenAI',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on GenAI and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The GenAI Enterprise license for your workspace has expired. Please contact your administrator to continue using GenAI.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect GenAI license server. Please contact your administrator to continue using GenAI.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The GenAI Enterprise license for your workspace is inactive. Please contact your administrator to continue using GenAI.',
  webapp: {
    login: 'Login',
