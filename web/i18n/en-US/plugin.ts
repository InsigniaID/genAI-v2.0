const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'View more',
    verifiedTip: 'Verified by GenAI',
    partnerTip: 'Verified by a GenAI partner',
  },
  task: {
  ...
  difyVersionNotCompatible: 'The current GenAI version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalGenAIVersion}}',
  auth: {
    default: 'Default',
    custom: 'Custom',
