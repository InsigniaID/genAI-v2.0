const translation = {
  tips: {
    loggedIn: 'This app wants to access the following information from your GenAI Cloud account.',
    notLoggedIn: 'This app wants to access your GenAI Cloud account',
