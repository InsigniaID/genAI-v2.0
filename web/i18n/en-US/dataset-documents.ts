const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to GenAI citations or indexed via the Chat plugin.',
    ...
    empty: {
      ...
      sync: {
        tip: 'GenAI will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
