const translation = {
  ...
  plansCommon: {
    ...
    apiRateLimitTooltip: 'API Rate Limit applies to all requests made through the GenAI API, including text generation, chat conversations, workflow executions, and document processing.',
    ...
    messageRequest: {
      ...
      tooltip: 'Message credits are provided to help you easily try out different OpenAI models in GenAI. Credits are consumed based on the model type. Once they’re used up, you can switch to your own OpenAI API key.',
    },
    annotatedResponse: {
    ...
    ragAPIRequestTooltip: 'Refers to the number of API calls invoking only the knowledge base processing capabilities of GenAI.',
  ...
  plans: {
    ...
    community: {
      ...
      features: [
        ...
        'Single Workspace',
        'Complies with GenAI Open Source License',
      ],
    },
    premium: {
      name: 'Premium',
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO',
        'Negotiated SLAs by GenAI Partners',
        'Advanced Security & Controls',
        'Updates and Maintenance by GenAI Officially',
