const translation = {
  tips: {
    notLoggedIn: 'Questa app vuole accedere al tuo account GenAI Cloud',
    loggedIn: 'Questa app vuole accedere alle seguenti informazioni dal tuo account GenAI Cloud.',
