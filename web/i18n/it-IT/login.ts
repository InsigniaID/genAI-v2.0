const translation = {
  ...
  welcome: 'Benvenuto su GenAI, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare GenAI Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su GenAI',
  invalid: 'Il link è scaduto',
  explore: 'Esplora GenAI',
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su GenAI e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze GenAI. Contatta il tuo amministratore per continuare a utilizzare GenAI.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza GenAI Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare GenAI.',
  licenseInactiveTip: 'La licenza GenAI Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare GenAI.',
