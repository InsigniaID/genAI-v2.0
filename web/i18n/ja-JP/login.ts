const translation = {
  ...
  license: {
    tip: 'GitHub のオープンソースライセンスを確認してから、GenAI Community Edition を開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'GenAI へのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの GenAI Enterprise ライセンスの有効期限が切れています。GenAI を引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの GenAI Enterprise ライセンスが非アクティブです。GenAI を引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'GenAI ライセンスサーバーへの接続に失敗しました。続けて GenAI を使用するために管理者に連絡してください。',
  webapp: {
    login: 'ログイン',
