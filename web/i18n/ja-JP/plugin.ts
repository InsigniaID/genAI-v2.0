const translation = {
  ...
  marketplace: {
    ...
    discover: '探索',
    and: 'と',
    difyMarketplace: 'GenAI マーケットプレイス',
    ...
    viewMore: 'もっと見る',
    verifiedTip: 'このプラグインは GenAI によって認証されています',
    partnerTip: 'このプラグインは GenAI のパートナーによって認証されています',
  },
  task: {
  ...
  difyVersionNotCompatible: '現在の GenAI バージョンはこのプラグインと互換性がありません。最小バージョンは{{minimalGenAIVersion}}です。',
  metadata: {
    title: 'プラグイン',
  },
