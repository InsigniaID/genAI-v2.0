const translation = {
  ...
  marketplace: {
    ...
    viewMore: 'Xem thêm',
    difyMarketplace: 'Thị trường GenAI',
    discover: 'Khám phá',
    ...
    and: 'và',
    verifiedTip: 'Được xác nhận bởi GenAI',
    partnerTip: 'Được xác nhận bởi một đối tác của GenAI',
  },
  task: {
  ...
  difyVersionNotCompatible: 'Phiên bản GenAI hiện tại không tương thích với plugin này, vui lòng nâng cấp lên phiên bản tối thiểu cần thiết: {{minimalGenAIVersion}}',
