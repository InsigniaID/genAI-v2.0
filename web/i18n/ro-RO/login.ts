const translation = {
  ...
  welcome: 'Bine ai venit la GenAI, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe GenAI Community Edition, citește',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe GenAI și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe GenAI. Contactați administratorul pentru a continua să utilizați GenAI.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența GenAI Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați GenAI.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența GenAI Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați GenAI.',
  webapp: {
