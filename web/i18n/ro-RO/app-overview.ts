const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a GenAI cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a GenAI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome GenAI Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
