const translation = {
  tips: {
    ...
    loggedIn: 'Această aplicație vrea să acceseze următoarele informații din contul tău GenAI Cloud.',
    notLoggedIn: 'Această aplicație vrea să acceseze contul tău GenAI Cloud',
