const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Se referă la numărul de apeluri API care invocă doar capacitățile de procesare a bazei de cunoștințe a GenAI.',
    ...
    apiRateLimitTooltip: 'Limita de rată API se aplică tuturor cererilor efectuate prin API-ul GenAI, inclusiv generarea de texte, conversațiile de chat, execuțiile fluxului de lucru și procesarea documentelor.',
  ...
  plans: {
    ...
    community: {
      features: {
        2: 'Respectă licența GenAI Open Source',
