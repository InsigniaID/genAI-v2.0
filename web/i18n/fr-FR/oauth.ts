const translation = {
  tips: {
    ...
    notLoggedIn: 'Cette application veut accéder à votre compte GenAI Cloud',
    ...
    loggedIn: 'Cette application veut accéder aux informations suivantes de votre compte GenAI Cloud.',
  },
  scopes: {
    email: 'E-mail',
    name: 'Nom',
