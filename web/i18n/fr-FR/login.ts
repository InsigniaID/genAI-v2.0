const translation = {
  ...
  welcome: 'Bienvenue sur GenAI, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer GenAI Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur GenAI',
  invalid: 'Le lien a expiré',
  explore: 'Explorez GenAI',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur GenAI et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence GenAI Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser GenAI.',
  licenseLostTip: 'Échec de la connexion au serveur de licences GenAI. Veuillez contacter votre administrateur pour continuer à utiliser GenAI.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence GenAI Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser GenAI.',
