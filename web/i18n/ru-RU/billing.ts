const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Относится к количеству вызовов API, вызывающих только возможности обработки базы знаний GenAI.',
    ...
    apiRateLimitTooltip: 'Ограничение скорости API применяется ко всем запросам, сделанным через API GenAI, включая генерацию текста, чатовую переписку, выполнение рабочих процессов и обработку документов.',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: {
        4: 'ССО',
        5: 'Согласованные SLA от GenAI Partners',
        ...
        7: 'Обновления и обслуживание от GenAI официально',
    ...
    community: {
      features: {
        ...
        2: 'Соответствует лицензии GenAI с открытым исходным кодом',
