const translation = {
  ...
  welcome: 'Willkommen bei GenAI, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit GenAI Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf GenAI beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'GenAI erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei GenAI angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des GenAI-Lizenzservers. Wenden Sie sich an Ihren Administrator, um GenAI weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die GenAI Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um GenAI weiterhin zu verwenden.',
  licenseExpiredTip: 'Die GenAI Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um GenAI weiterhin zu verwenden.',
