const translation = {
  ...
  plansCommon: {
    ...
    ragAPIRequestTooltip: 'Bezieht sich auf die Anzahl der API-Aufrufe, die nur die Wissensdatenbankverarbeitungsfähigkeiten von GenAI aufrufen.',
    ...
    cloud: 'Cloud-Dienst',
    apiRateLimitTooltip: 'Die API-Datenbeschränkung gilt für alle Anfragen, die über die GenAI-API gemacht werden, einschließlich Textgenerierung, Chat-Konversationen, Workflow-Ausführungen und Dokumentenverarbeitung.',
    getStarted: 'Loslegen',
  ...
  plans: {
    ...
    enterprise: {
      ...
      features: [
        ...
        'SSO (Single Sign-On)',
        'Vereinbarte SLAs mit GenAI-Partnern',
        'Erweiterte Sicherheitsfunktionen und Kontrollen',
        'Offizielle Updates und Wartung durch GenAI',
    ...
    community: {
      ...
      features: [
        ...
        'Entspricht der GenAI Open-Source-Lizenz',
      ],
    },
    premium: {
