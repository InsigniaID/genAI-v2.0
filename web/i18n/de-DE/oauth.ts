const translation = {
  tips: {
    ...
    notLoggedIn: 'Diese App möchte auf Ihr GenAI Cloud-Konto zugreifen',
    loggedIn: 'Diese App möchte auf die folgenden Informationen aus Ihrem GenAI Cloud-Konto zugreifen.',
