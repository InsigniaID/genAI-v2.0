const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'GenAI-Konto',
    langGeniusAccountTip: 'Ihr GenAI-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei GenAI anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von GenAI ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in GenAIs Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'GenAI {{version}} ist jetzt verfügbar.',
    latestAvailable: 'GenAI {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
