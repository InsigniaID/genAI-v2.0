const translation = {
  ...
  license: {
    tip: 'Sebelum memulai Edisi Komunitas GenAI, baca GitHub',
  ...
  joinTipEnd: 'tim di GenAI',
  dontHave: 'Belum?',
  passwordChangedTip: 'Kata sandi Anda telah berhasil diubah',
  validate: 'Memvalidasi',
  resetPasswordDesc: 'Ketik email yang Anda gunakan untuk mendaftar di GenAI dan kami akan mengirimkan email reset kata sandi kepada Anda.',
  licenseLostTip: 'Gagal menghubungkan server lisensi GenAI. Hubungi administrator Anda untuk terus menggunakan GenAI.',
  signBtn: 'Masuk',
  sendResetLink: 'Kirim tautan reset',
  createAndSignIn: 'Buat dan masuk',
  licenseExpiredTip: 'Lisensi GenAI Enterprise untuk ruang kerja Anda telah kedaluwarsa. Hubungi administrator Anda untuk terus menggunakan GenAI.',
  email: 'Alamat email',
  noLoginMethodTip: 'Silakan hubungi admin sistem untuk menambahkan metode autentikasi.',
  adminInitPassword: 'Kata sandi inisialisasi admin',
  licenseInactiveTip: 'Lisensi GenAI Enterprise untuk ruang kerja Anda tidak aktif. Hubungi administrator Anda untuk terus menggunakan GenAI.',
  rightTitle: 'Buka potensi penuh LLM',
  welcome: '👋 Selamat datang di GenAI, silakan login untuk melanjutkan.',
