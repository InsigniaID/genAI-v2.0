const translation = {
  toVerifiedTip: {
    end: 'untuk Paket Profesional GenAI.',
  ...
  form: {
    ...
    terms: {
      ...
      option: {
        ...
        inSchool: 'Saya mengonfirmasi bahwa saya terdaftar atau dipekerjakan di lembaga yang disediakan. GenAI dapat meminta bukti pendaftaran/pekerjaan. Jika saya salah menggambarkan kelayakan saya, saya setuju untuk membayar biaya apa pun yang awalnya dibebaskan berdasarkan status pendidikan saya.',
      },
  ...
  notice: {
    expired: {
      summary: {
        ...
        line1: 'Anda masih dapat mengakses dan menggunakan GenAI.',
      },
  ...
  successTitle: 'Anda telah mendapatkan GenAI Education Verified',
  rejectTitle: 'Verifikasi Pendidikan GenAI Anda telah ditolak',
  successContent: 'Kami telah mengeluarkan kupon diskon 100% untuk paket GenAI Professional ke akun Anda. Kupon berlaku selama satu tahun, harap gunakan dalam masa berlaku.',
  emailLabel: 'Email Anda saat ini',
  rejectContent: 'Sayangnya, Anda tidak memenuhi syarat untuk status Education Verified dan oleh karena itu tidak dapat menerima kupon 100% eksklusif untuk Paket GenAI Professional jika Anda menggunakan alamat email ini.',
