const translation = {
  list: {
    ...
    empty: {
      ...
      sync: {
        tip: 'GenAI akan mengunduh file dari Notion Anda secara berkala dan menyelesaikan pemrosesan.',
      },
    ...
    desc: 'Semua file Pengetahuan ditampilkan di sini, dan seluruh Pengetahuan dapat ditautkan ke kutipan GenAI atau diindeks melalui plugin Obrolan.',
